...
export default function MentorDetailPage() {
  ...
  const fetchMentor = useCallback(
    ...
    [router],
  ) // Add router to the dependency array since it's used inside the callback
  ...
  const handleBookSession = useCallback(
    (mentorId: string, mentorshipIndex: number) => {
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                {/* Replace the existing rating display with MentorBadgeSet */}
                <MentorBadgeSet
              ...
              <Card>
                ...
                <CardContent>
                  {mentor.reviews.length === 0 ? (
                    <div>
                      <p className="text-muted-foreground mb-6">No reviews yet for this mentor.</p>

                      {/* Add SuggestedMentorships when no reviews are available */}
                      <div className="mt-4">
                        <SuggestedMentorships
                          contextTag={mentor.expertise[0] || "medical"}
                          title="Highly rated mentors in this field"
                          limit={3}
                        />
                      </div>
                    </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      {!selectedDate ? (
                        ...
                        <div>
                          <p className="text-muted-foreground mb-6">No available slots for this date</p>

                          {/* Add SuggestedMentorships when no slots are available */}
                          <div className="mt-4">
                            <SuggestedMentorships
                              contextTag={mentor.expertise[0] || "medical"}
                              title="Mentors with availability"
                              limit={2}
                            />
                          </div>
                        </div>
                  ...
                  <div className="mt-6">
                    <p className="text-sm text-muted-foreground mb-4">
                      After selecting a date and time, choose a mentorship program from the &quot;Mentorships&quot; tab
