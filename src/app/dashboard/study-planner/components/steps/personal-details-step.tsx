              ...
              <div className="flex flex-col items-center text-center">
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${
                    formData.currentLevel === level ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-500"
                  }`}
                >
                  {index + 1}
                </div>
                <div className={`font-medium ${formData.currentLevel === level ? "text-blue-700" : "text-gray-700"}`}>
